...
import { getCachedCredentials, refreshIfNeeded, syncAuthJson, } from "./credentials.js";
...
export { getCachedCredentials, refreshIfNeeded, syncAuthJson, } from "./credentials.js";
...
export function getBillingHeader(modelId) {
...
const plugin = async () => {
    ...
    if (freshCreds) {
        ...
        console.warn("opencode-claude-auth: Claude credentials are expired and could not be refreshed via Claude CLI.");
    }
