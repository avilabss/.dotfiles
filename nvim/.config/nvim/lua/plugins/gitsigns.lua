-- gitsigns shows added, changed, and deleted lines in the sign column.
-- It also provides hunk staging/resetting, previews, blame, and diffs without leaving
-- Neovim. Navigate changes with ]c/[c and use <leader>g for Git actions.
return {
    {
